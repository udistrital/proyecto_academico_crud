...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/proyecto_academico_crud/controllers:ModalidadController"] = append(beego.GlobalControllerRouter["github.com/udistrital/proyecto_academico_crud/controllers:ModalidadController"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
