...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/proyecto_academico_crud/controllers:InstitucionEnfasisController"] = append(beego.GlobalControllerRouter["github.com/udistrital/proyecto_academico_crud/controllers:InstitucionEnfasisController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
    ...
    beego.GlobalControllerRouter["github.com/udistrital/proyecto_academico_crud/controllers:ProyectoAcademicoRolPersonaDependeciaController"] = append(beego.GlobalControllerRouter["github.com/udistrital/proyecto_academico_crud/controllers:ProyectoAcademicoRolPersonaDependeciaController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
